...
<%
	...
	urlString = urlString.replaceAll("WEB-INF/pages/enterpriseMircoApp/enterpriseSsoMircoApp.jsp", "enterpriseMircoApp/sso");
...
%>
//在此拿到权限验证配置所需要的信息
var _config = <%= com.dreamaker.controller.signature.SignatureController.getEnterpriseSsoMircoAppConfig(request,url) %>;
</script>
